...
public class EditedWebcamViewer extends StaticWidget implements Runnable {
    ...
    private static BufferedImage frame2 = null;
    ...
    public static BufferedImage getLatestCapture() {
    	return frame2;
    }
                ...
                while (!Thread.interrupted() &&
                    ...
                    try {
                        ...
                        synchronized (this.frameMutex) {
                            ...
                            this.frame2 = ImageIO.read(new ByteArrayInputStream(data));
    ...
    protected void paintComponent(Graphics g) {
        ...
        synchronized (this.frameMutex) {
            ...
            if (this.frame2 != null) {
                ...
                float imageAspectRatio = (float) this.frame2.getWidth(null) / this.frame2.getHeight(null);
                ...
                g.drawImage(this.frame2, imageX, imageY, imageWidth, imageHeight, null, null);
            }
